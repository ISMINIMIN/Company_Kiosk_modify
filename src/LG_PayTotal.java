...
public class LG_PayTotal extends LogoFix {
	...
	public LG_PayTotal(MainFrame f) {
		...
		lbl3.setBounds(245, 360, 270, 50);
     	...
     	LGDiscount = new JLabel(); // 할인 금액이 출력됨
     	LGDiscount.setFont(new Font("맑은 고딕", Font.BOLD, 25));
		...
		lbl4.setBounds(245, 420, 270, 50);
     	...
     	LGlblTotal = new JLabel(); // 할인 금액이 출력됨
     	LGlblTotal.setFont(new Font("맑은 고딕", Font.BOLD, 25));
