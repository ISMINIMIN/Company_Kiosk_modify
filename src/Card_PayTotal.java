...
public class Card_PayTotal extends LogoFix {
	
	public static JLabel lblTotal, CARDlblTotal, CARDDiscount;
	private JLabel lbl1, lbl2, lbl3, lbl4;
	private JButton btnCancle, btnPay;

	public Card_PayTotal(MainFrame f) {
		...
		lbl3.setBounds(245, 360, 270, 50);
     	...
     	CARDDiscount = new JLabel(); // 할인 금액이 출력됨
     	CARDDiscount.setFont(new Font("맑은 고딕", Font.BOLD, 25));
     	CARDDiscount.setBounds(360, 370, 200, 30);
		add(CARDDiscount);
		...
		lbl4.setBounds(245, 420, 270, 50);
     	...
     	CARDlblTotal = new JLabel(); // 할인 금액이 출력됨
     	CARDlblTotal.setFont(new Font("맑은 고딕", Font.BOLD, 25));
     	CARDlblTotal.setBounds(360, 430, 200, 30);
     	CARDlblTotal.setForeground(new Color(0,105,92));
		add(CARDlblTotal);
