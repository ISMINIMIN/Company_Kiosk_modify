...
public class KT_PayTotal extends LogoFix {
	...
	public KT_PayTotal(MainFrame f) {
		...
		lbl3.setBounds(245, 360, 270, 50);
     	...
     	KTDiscount = new JLabel(); // 할인 금액이 출력됨
     	KTDiscount.setFont(new Font("맑은 고딕", Font.BOLD, 25));
		...
		lbl4.setBounds(245, 420, 270, 50);
     	...
     	KTlblTotal = new JLabel(); // 할인 금액이 출력됨
     	KTlblTotal.setFont(new Font("맑은 고딕", Font.BOLD, 25));
